...
idle-activation-enabled setting with the following command:Note: The example
...
\"local\" is being used.# grep -i idle-activation-enabled
/etc/dconf/db/local.d/locks/*/org/gnome/desktop/screensaver/idle-activation-enabledIf
...
setting:/org/gnome/desktop/screensaver/idle-activation-enabled"
end
